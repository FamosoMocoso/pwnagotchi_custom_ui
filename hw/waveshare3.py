...
class WaveshareV3(DisplayImpl):
    ...
    def layout(self):
        fonts.setup(10, 8, 10, 25, 30, 9)
        self._layout['width'] = 250
        self._layout['height'] = 122
        self._layout['face'] = (0, 44)
        self._layout['name'] = (0, 16)
        self._layout['channel'] = (0, 0)
        self._layout['aps'] = (40, 0)
        self._layout['uptime'] = (185, 0)
        self._layout['line1'] = [0, 14, 250, 14]
        self._layout['line2'] = [0, 108, 250, 108]
        self._layout['line3'] = [0, 78, 128, 78]
        self._layout['line4'] = [0, 90, 250, 90]
        self._layout['line5'] = [128, 14, 128, 90]
        self._layout['line6'] = [62, 78, 62, 90]
